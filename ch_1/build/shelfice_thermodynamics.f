...
C $Header: /u/gcmpack/MITgcm/pkg/shelfice/shelfice_thermodynamics.F,v 1.47 2015/12/17 01:52:05 jmc Exp $
C $Name:  $
...
C     where this value is part of the protocol
      IF ( convertFW2SaltLoc .EQ. -1. ) convertFW2SaltLoc = 33.4D0
...
C--   compute surface tendencies
     ...
     &           * ( cFac*sLoc(I,J) + (1.D0-cFac)*convertFW2SaltLoc )
